...
The API First Design strategy is used to develop ASP.NET Core Web APIs  automatically generated by Swagger Hub. The  faster build and availability of Visual Studio environment are the key advantages of this workflow targeting the Raspberry Pi.
