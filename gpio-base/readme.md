...
The good news is that if you are installing Lirc for the first time, the current Raspberry Pi / Raspbian Stretch comes with Lircd version 0.9.4c that applies several improvements to make your life much better.
